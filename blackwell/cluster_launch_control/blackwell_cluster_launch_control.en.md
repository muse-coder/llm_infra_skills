...
> Source: <https://docs.nvidia.com/cutlass/latest/media/docs/cpp/blackwell_cluster_launch_control.html>
...
![GEMM tiles are evenly divided among available SMs](images/non_persistent.png)
...
![GEMM tiles are unevenly divided among available SMs, leading to workload imbalance](images/persistent_static.png)
...
![GEMM tiles are dynamically allocated among available SMs, leading to a balanced workload](images/persistent_clc.png)
